...
update - to update the bot [owner only]
```
...
- **TELEGRAPH_TOKEN** : Telgraph Token generate with 👉[![Run on Repl.it](https://repl.it/badge/github/kognise/repl.it-mobile)](https://repl.it/@JarvisRemote/gentelegraphtoken) or
```python3 generate_string_session.py```
- **USER_SESSION_STRING** : Session string generated by running: 👉[![Run on Repl.it](https://repl.it/badge/github/kognise/repl.it-mobile)](https://repl.it/@JarvisRemote/generatestringsession) or
```python3 generate_telegraph_token.py```
