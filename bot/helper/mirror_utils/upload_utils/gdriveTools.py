...
from bot import TUTORIAL_LINK, parent_id, DOWNLOAD_DIR, IS_TEAM_DRIVE, INDEX_URL, \
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if SHORTENER is not None and SHORTENER_API is not None:
                    surl = urlshortnners(theurlis=durl)
                ...
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        siurl = urlshortnners(theurlis=url)
                        siurls = urlshortnners(theurlis=urls)
        ...
        if response["files"]:
            ...
            for file in response.get('files', []):
                ...
                if file.get('mimeType') == "application/vnd.google-apps.folder":
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        sfurl = urlshortnners(theurlis=furl)
