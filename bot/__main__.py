...
from bot import SHORTENER, SHORTENER_API, app
...
def stats(update, context):
    ...
    stats = f'<b>╭──「  ⭕️ BOT STATS ⭕️ 」 </b>\n' \
            ...
            f'<b>├  🗄 DISK : {disk}%</b>\n' \
            f'<b>│</b>\n' \
            f'<b>╰──「  🚸<a href="https://t.me/kjuned007"><b> Juned KH </b></a>🚸 」 </b>'
...
'''
    ...
    buttons.buildbutton("My Mirror Group", "https://t.me/torrent_to_drive")
    ...
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        if update.message.chat.type == "private":
            ...
            update.effective_message.reply_photo(
                IMAGE_URL, start_string, parse_mode=ParseMode.MARKDOWN, reply_markup=reply_markup)
    else:
...
botcmds = [
    ...
    BotCommand(f'{BotCommands.CountCommand}',
               'Count file/folder of Drive link'),
    ...
    BotCommand(f'{BotCommands.MediaInfoCommand}',
    ...
    BotCommand(f'{BotCommands.RestartCommand}',
               'Restart bot [owner/sudo only]'),
    BotCommand('1337x', '[query] Searches Torrent in 1337x'),
    BotCommand('yts', '[query] Searches Torrent in yts'),
    BotCommand('tgx', '[query] Searches Torrent in tgx'),
    BotCommand('piratebay', '[query] Searches Torrent in piratebay')]
