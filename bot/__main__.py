...
from bot import bot, dispatcher, updater, botStartTime, SHORTENER, SHORTENER_API, SHORTENERLINK_API
...
def main():
    ...
    LOGGER.info("Shortner %s\nShortner API %s\nBITLY API %s"%(SHORTENER,SHORTENER_API,SHORTENERLINK_API))
